...
public class TestPrioritizedSubscribers extends TestCase {
    ...
    public void testPriorityAnnotation() throws EventServiceExistsException {
        ...
        OrderRecorder sn100 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventSubscriber(eventClass = Color.class, eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -100)
        ...
        OrderRecorder sn10 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventSubscriber(eventClass = Color.class, eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -10)
            public void annotateMe(Object foo) {
                record();
            }
        };
        OrderRecorder s0_2 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventSubscriber(eventClass = Color.class, eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = 0)
            public void annotateMe(Object foo) {
                record();
            }
        };
        OrderRecorder s0_3 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventSubscriber(eventClass = Color.class, eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION)
            public void annotateMe(Object foo) {
                record();
            }
        };
        OrderRecorder s50 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventSubscriber(eventClass = Color.class, eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = 50)
            public void annotateMe(Object foo) {
                record();
            }
        };
    ...
    public void testPriorityTopicAnnotation() throws EventServiceExistsException {
        ...
        List<OrderRecorder> calledOrder = new ArrayList<OrderRecorder>();
        OrderRecorder sn100 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicSubscriber(topic = "Color", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -100)
        ...
        OrderRecorder sn10 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicSubscriber(topic = "Color", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -10)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder s0_2 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicSubscriber(topic = "Color", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = 0)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder s0_3 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicSubscriber(topic = "Color", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder s50 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicSubscriber(topic = "Color", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = 50)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
    ...
    public void testPriorityTopicPatternAnnotation() throws EventServiceExistsException {
        ...
        List<OrderRecorder> calledOrder = new ArrayList<OrderRecorder>();
        OrderRecorder sn100 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicPatternSubscriber(topicPattern = "Col[a-z]+", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -100)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder sn50 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicPatternSubscriber(topicPattern = "Col[a-z]+", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -50)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        ...
        OrderRecorder sn10 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicPatternSubscriber(topicPattern = "Col[a-z]+", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = -10)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder s0_2 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicPatternSubscriber(topicPattern = "Col[a-z]+", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION, priority = 0)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
        OrderRecorder s0_3 = new OrderRecorder(calledOrder) {
            @org.bushe.swing.event.annotation.EventTopicPatternSubscriber(topicPattern = "Col[a-z]+", eventServiceName = EVENT_SERVICE_TEST_PRIORITY_ANNOTATION)
            public void annotateMe(String topic, Object foo) {
                record();
            }
        };
