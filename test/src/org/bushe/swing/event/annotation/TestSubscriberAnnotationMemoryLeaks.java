...
public class TestSubscriberAnnotationMemoryLeaks extends TestCase {
   ...
   private Object createSubscriber(EventService es) {
      ...
      if (randNum == 0) {
         ...
         if (true || randNum == 0) {
            ...
            es.subscribe(topic, (org.bushe.swing.event.EventTopicSubscriber)result);
         } else {
            //annotated
   ...
   private static class DummyTopicSubscriber implements org.bushe.swing.event.EventTopicSubscriber {
      public void onEvent(String topic, Object data) {
      }
   }
   
   private static class AnnotatedDummySubscriber  {
      @org.bushe.swing.event.annotation.EventSubscriber(eventClass=List.class)
