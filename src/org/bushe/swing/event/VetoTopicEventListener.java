...
public interface VetoTopicEventListener {
    ...
    * <p>Prequisite: VetoTopicEventListener has to be subscribed with the EventService for the topic name.</p>
    ...
    *
    * @return true if the publication on the topic should be vetoed and not published, false if the data should be published on the topic.
    */
